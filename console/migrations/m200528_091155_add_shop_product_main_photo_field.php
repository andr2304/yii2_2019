...
/**
 * Class m200528_091155_add_shop_product_main_photo_field
 */
class m200528_091155_add_shop_product_main_photo_field extends Migration
{
    public function up()
    {
    ...
    public function down()
    {
        echo "m200528_091155_add_shop_product_main_photo_field cannot be reverted.\n";
